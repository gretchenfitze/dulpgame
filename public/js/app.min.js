	...
	var Game = function () {
	  ...
	  */
		function Game() {
			...
			this.gameColors = ['#f63b31', '#FF7A00', '#FFAA1D', '#FFF700', '#33ff47', '#AAF0D1', '#50BFE6', '#0066CC', '#6B3FA0', '#F653A6', '#1B1B1B', '#e6e6e6'];
		}
	  ...
	  */
	   ...
	   */
			...
			key: '_initRandomLevel',
			value: function _initRandomLevel() {
				this.minSlice = 15;
				this.maxSlice = 150;
				this.levelNumber = '∞';
