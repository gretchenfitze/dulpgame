...
/***/ function(module, exports, __webpack_require__) {
	...
	var _viewportUnitsBuggyfill = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Bullets = __webpack_require__(8);
	...
	var Game = function () {
	  ...
	  */
		function Game() {
			...
			this.gameColors = ['#f472d0', '#e51400', '#FF6E40', '#FFAB40', '#FFFF00', '#60a917', '#76FF03', '#64FFDA', '#64B5F6', '#0050ef', '#B388FF', '#9C27B0', '#9E9E9E', '#8D6E63'];
		}
	  ...
	  */
		...
		_createClass(Game, [{
			...
			key: '_initRandomLevels',
			value: function _initRandomLevels() {
				this.minSlice = 15;
				this.maxSlice = 150;
				this.levelNumber = '∞';
	   ...
	   */
			...
			key: '_addRandomSlice',
			value: function _addRandomSlice() {
	   ...
	   */
			...
			key: '_sumOfSlices',
			value: function _sumOfSlices() {
				return this.colorSliceRandom.reduce(function (slice1, slice2) {
	 ...
	 */
	   ...
	   */
			...
			value: function getHitSector() {
				...
				this.y = this.el.parentNode.offsetTop + this.el.clientHeight - (this.el.clientHeight - this.center.clientHeight) / 4;
	...
	var Bullets = function () {
	  ...
	  */
		...
		_createClass(Bullets, [{
			...
			value: function rebound() {
				...
				if (this.boundingBullet) {
					this.circleStep = Math.PI * this.rotatingCircle.clientWidth / 2 * this.level.circleSpeed / 180;

					this.fromCircleToBottom = document.documentElement.clientHeight - this.boundingBullet.offsetTop + this.fullPath;

					this.boundAngle = this._degreesToRads(this.boundAngleFrom + Math.random() * (this.boundAngleTo - this.boundAngleFrom));
					this.reboundPath = this.fromCircleToBottom / Math.sin(this._degreesToRads(90) - this.boundAngle);
					...
					this.boundingBullet.style.transition = 'transform ' + this.reboundPath / (this.bulletStep / this._stepInterval) * this.reboundSpeedCorrection + 'ms';
	   ...
	   */
			...
			key: '_degreesToRads',
			value: function _degreesToRads(angle) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./addtohomescreen.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./addtohomescreen.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
