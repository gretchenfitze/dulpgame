...
/***/ function(module, exports, __webpack_require__) {
	...
	var Circle = function () {
		function Circle(level, colors) {
			...
			this.spinDegree = 0;
			this.circleSpeed = +this.level.name % 2 ? +this.level.circleSpeed : 0 - this.level.circleSpeed;
		}
		...
		_createClass(Bullets, [{
			...
			value: function rebound() {
				...
				if (this.boundingBullet) {
					...
					this.boundingBullet.style.transition = 'transform ' + this.reboundPath / (this.bulletStep / this._stepInterval) + 'ms';

					this.boundingBullet.style.transform = +this.level.name % 2 ? 'translate(-' + this.boundPathX + 'px,\n\t\t\t\t' + this.boundPathY + 'px)' : 'translate(' + this.boundPathX + 'px,\n\t\t\t\t' + this.boundPathY + 'px)';
