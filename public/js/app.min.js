	...
	*/
	 ...
	 */
		...
		function Game(level) {
			...
			this.circle = new _Circle2.default(this.levelOptions);
			this.bullets = new _Bullets2.default(this.levelOptions);
			this._lastTime = 0;
			this.fire = false;
		}
...
/***/ function(module, exports) {
	...
	var Bullets = function () {
		...
		_createClass(Bullets, [{
			...
			key: '_makeActiveBullet',
			value: function _makeActiveBullet() {
